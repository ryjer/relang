...
单词信息体 文件_扫描单词(FILE * 输入文件) {
    ...
    if (是字母(读入字符.字符)||是汉字(读入字符.字符)||(读入字符.字符=='_')) {
        ...
        if (读入字符.字符 != '0') {                         //10进制数字
            do {
                unicode切片_追加(&(单词信息.单词切片), 读入字符.字符);
                单词信息.数字值 = 单词信息.数字值*10 + (读入字符.字符-'0');
                读入字符 = 文件_扫描字符(输入文件); //读入下一字符
                if (读入字符.错误 == EOF) { //文件结束，停止读取跳出循环
                    break;
                }
            ...
            if (读入字符.字符=='x' || 读入字符.字符=='h') {     //16进制数
                ...
                if (是16进制数字(读入字符.字符)) {
                    do {
                        unicode切片_追加(&(单词信息.单词切片), 读入字符.字符);
                        单词信息.数字值 = 单词信息.数字值*16 + 十六进制字符转数字(读入字符.字符);
                        读入字符 = 文件_扫描字符(输入文件);
                        if (读入字符.错误 == EOF) {
                            break;
                        }
                ...
                if ('0'<=读入字符.字符 && 读入字符.字符<='7') {
                    do {
                        unicode切片_追加(&(单词信息.单词切片), 读入字符.字符);
                        单词信息.数字值 = 单词信息.数字值*8 + 十六进制字符转数字(读入字符.字符);
                        读入字符 = 文件_扫描字符(输入文件);
                        if (读入字符.错误 == EOF) {
                            break;
                        }
                ...
                if ('0'<=读入字符.字符 && 读入字符.字符<='1') {
                    do {
                        unicode切片_追加(&(单词信息.单词切片), 读入字符.字符);
                        单词信息.数字值 = 单词信息.数字值*2 + 十六进制字符转数字(读入字符.字符);
                        读入字符 = 文件_扫描字符(输入文件);
                        if (读入字符.错误 == EOF) {
                            break;
                        }
...
int main() {
    ...
    while (单词信息.错误 != EOF) {
        ...
        // 条件输出 数字值和错误
        if (单词信息.类型 == 数字字面量) {printf("%ld %#lx %#o\t ", 单词信息.数字值, 单词信息.数字值, 单词信息.数字值);}
