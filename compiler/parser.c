...
表达式节点 * 二元表达式_解析() {
    ...
    case 双与号: case 双竖线:
    case 双小于: case 双大于: case 与号: case 逻辑与: case 竖线: case 逻辑或: case 杨抑号: case 逻辑异或:
        节点 = 解析器_创建表达式节点(单词类型_二元表达式节点类型表[当前单词.类型], 节点, NULL, 一元表达式_解析());
        /* code */
        break;
    // 《二元表达式》随符集: ? , 、) ] 
    ...
    case 右圆括号: case 右方括号:
        break;
    default:
        perror("《二元表达式》解析错误: 不明二元运算符 或 随符集匹配失败\n");
        break;
    }
}
